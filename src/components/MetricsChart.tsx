      ...
      {hasLive && hasBt && (
        <div className="card">
          ...
          <div className="grid gap-3 sm:grid-cols-4">
            ...
            <SummaryCard label="±0.5°C Live" value={`${live.accuracy_pct.toFixed(1)}%`} sub={`Backtest: ${bt.overall_accuracy_05c.toFixed(1)}%`} color="text-emerald-400" />
          </div>
        </div>
      )}
      ...
      {!hasLive && hasBt && (
        <div className="card">
          ...
          <div className="grid gap-3 sm:grid-cols-4">
            ...
            <SummaryCard label="±0.5°C" value={`${bt.overall_accuracy_05c.toFixed(1)}%`} sub="Precisión del modelo" color="text-emerald-400" />
          </div>
        </div>
      )}
      ...
      {hasLive && !hasBt && (
        <div className="card">
          ...
          <div className="grid gap-3 sm:grid-cols-4">
            ...
            <SummaryCard label="±0.5°C" value={`${live.accuracy_pct.toFixed(1)}%`} sub={`${live.total_muestras} muestras`} color="text-emerald-400" />
          </div>
        </div>
      )}
